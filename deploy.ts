...
async function restartServer() {
  try {
    ...
    // 重启pm2项目
    // await runCommand(`cd ${webDir}/node-server`, `${webDir}/node-server`);
    // console.log("重启pm2服务");
    // await runCommand(`pm2 restart app.js`, `${webDir}/node-server`);
